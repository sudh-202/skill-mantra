            ...
            <section className="py-12 px-[1vw] bg-white">
                ...
                <div className="flex flex-wrap justify-center gap-8">
                    {cardsData.map((card, index) => (
                        ...
                        >
                            <div className="w-full h-72 flex items-center justify-center text-white text-[6vw]">
                                <card.icon />
                            </div>
                            <div className="mt-4">
                                <h3 className="text-[2vw] font-semibold text-center text-white">{card.title}</h3>
