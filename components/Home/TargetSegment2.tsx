...
const TargetSegment: React.FC = () => {
  ...
  return (
    <div className="pb-20 pt-48 mt-[20px] bg-blue-90 text-white  relative">
        ...
        {target.map((feature, index) => (
          ...
          <Card key={index} className=" relative flex flex-col items-center md:justify-center justify-between text-center md:w-1/5  bg-white pt-[5vw] pb-[3vw]  rounded-[40px] ">
            ...
            <CardFooter className="flex justify-center mt-auto p-4">
              <Link href="https://courses.skillmantra.in/register" passHref className="bg-[#AABDE1] text-blue-90 px-4 py-2 rounded-md hover:bg-gray-10 transition-colors duration-300 md:text-[1.5vw]">
                Enroll Now
              </Link>
            </CardFooter>
          </Card>
