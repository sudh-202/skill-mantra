...
import { WhyCourse, WhyCourseHeading } from "@/constants";
    ...
    return (
        <section className="py-[5vw] bg-blue-90 overflow-hidden">
                    ...
                    {WhyCourse.map((feature, index) => (
                        ...
                        >
                            <div className="mb-4 flex justify-center">
                                ...
                                <feature.icon size={48} className="text-blue-90" />
                            </div>
            ...
            <div className="relative border-b-2 border-white overflow-hidden">
                ...
                >
                    <Image src="/courses/car.webp" alt='stats-panel' width={200} height={100} className='transform scale-x-[-1]' />
                </motion.div>
            </div>
        </section>
    );
