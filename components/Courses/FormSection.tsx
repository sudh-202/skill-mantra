...
const FormSection = () => {
    return (
        <section className="flex flex-col md:flex-row justify-center items-center gap-[15vw]  bg-blue-90 md:px-[4vw] px-[5vw] mx-auto  py-[15vw] md:py-[4vw] z-30 md:space-x-[0%]"> 
