...
const Steps: React.FC = () => {
    return (
        <main className="flex flex-col items-center bg-white py-[6vw]  px-[6vw] ">
            <h1 className="md:text-[4vw] tracking-tight text-[7vw] font-semibold text-blue-90 pb-[30px]">Program Cycle</h1>
            <h2 className=" md:text-[2vw] text-[4vw]  text-blue-90 text-center tracking-tight pb-[30px]">
                There are 3 simple steps in the Program Cycle which are detailed below:
            </h2>
            <Image src="/courses/1.webp" alt="Steps"  width={100} height={100} className="w-[50vw]  "/>
