...
const Steps: React.FC = () => {
    return (
        <main className="flex flex-col justify-center items-center bg-yellow-50 py-[3vw]">
            <h1 className="text-[4vw] font-semibold text-blue-90 pb-[2vw]">Program Cycle</h1>
            <h2 className=" text-[2vw] pb-[2vw] text-blue-90">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center space-y-6 md:space-y-0 md:space-x-12 mt-8">
                {stepsData.map((stepData, index) => (
                    <div key={index} className="flex flex-col items-center text-center">
                        ...
                        <p className="mt-4 font-medium text-[1.2vw] text-blue-90">{stepData.title}</p>
                    </div>
                ))}
            </div>
        </main>
